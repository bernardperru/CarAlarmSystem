...
//L4
        ...
        assertFalse(cas.c>=20 && cas.d>=20 && cas.g>=20 && cas.c-cas.d<=0 && cas.g-cas.d<=0 && cas.c-cas.g<=0 && cas.d-cas.g<=0);
    }
    //BVA Variant
    @Test
    public void test12() {
...
//L12
        ...
        assertTrue(cas.c>=50 && cas.d>=30 && cas.d<=300 && cas.g>=50 && cas.d-cas.c<=-20 && cas.c-cas.g<=0 && cas.d-cas.g<=-20);
        cas.wait(270);
        assertFalse(cas.c>=50 && cas.d>=30 && cas.d<=300 && cas.g>=50 && cas.d-cas.c<=-20 && cas.c-cas.g<=0 && cas.d-cas.g<=-20);
//L13
        assertTrue(cas.locked && !cas.armed && !cas.closed && !cas.sound && cas.flash);
        assertFalse(cas.c>=320 && cas.d>=300 && cas.d<=300 && cas.g>=320 && cas.d-cas.c<=-20 && cas.c-cas.g<=0 && cas.d-cas.g<=-20);
        cas.wait(0);
        assertFalse(cas.c>=320 && cas.d>=300 && cas.d<=300 && cas.g>=320 && cas.d-cas.c<=-20 && cas.c-cas.g<=0 && cas.d-cas.g<=-20);
//L7
        assertFalse(cas.locked && !cas.armed && !cas.closed && !cas.sound && !cas.flash);
...
//L7
        assertFalse(cas.locked && !cas.armed && !cas.closed && !cas.sound && !cas.flash);
        assertFalse(cas.c>=320 && cas.d>=300 && cas.g>=320 && cas.d-cas.c<=-20 && cas.c-cas.g<=0 && cas.d-cas.g<=-20);
        cas.wait(0);
        assertFalse(cas.c>=320 && cas.d>=300 && cas.g>=320 && cas.d-cas.c<=-20 && cas.c-cas.g<=0 && cas.d-cas.g<=-20);
//L5
        cas.close();
        assertFalse(cas.locked && !cas.armed && cas.closed && !cas.sound && !cas.flash);
        cas.d = 0;
        assertFalse(cas.c>20 && cas.g>=320 && cas.d-cas.c<-20 && cas.c-cas.g<=0 && cas.d-cas.g<=-320);
        cas.wait(0);
        assertFalse(cas.c>20 && cas.g>=320 && cas.d-cas.c<-20 && cas.c-cas.g<=0 && cas.d-cas.g<=-320);
//L4
        assertFalse(cas.locked && cas.armed && cas.closed && !cas.sound && !cas.flash);
